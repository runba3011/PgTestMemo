...
public class Monster {
  ...
  public int calcCapturedPoint() {
    return this.hpValue + this.powerValue + this.defenseValue;
  }
   ...
   */
  public boolean getIsCaptured(int correctValue) {
    int randomValue = random.nextInt(Define.CAPTURE_RATE_MAX);
